...
export function ExpertiseCard({ area, index }: ExpertiseCardProps) {
    ...
    >
      <motion.div
        ...
        style={{
          ...
          y: hasTilt ? liftY : 0,
          borderColor: isHovered ? `${motifColors[area.motif].border}0.15)` : undefined,
        }}
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background: `radial-gradient(circle at var(--glow-x, 50%) var(--glow-y, 50%), ${motifColors[area.motif].glow}0.05), transparent 60%)`,
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            background: `linear-gradient(90deg, transparent, ${motifColors[area.motif].border}0.12), transparent)`,
          }}
        />
        ...
        <div className="relative z-10 flex flex-col h-full gap-3">
          ...
          >
            <span
              ...
              style={{ color: `${motifColors[area.motif].border}0.4)`, transform: hasTilt ? "translateZ(8px)" : undefined }}
            >
              {area.number}
            </span>
          ...
          >
            {area.technologies.map((tech) => (
              <span
                key={tech}
                className={`text-[11px] font-mono ${motifColors[area.motif].tag} ${motifColors[area.motif].tagBg} px-2 py-0.5 rounded-md`}
              >
                {tech}
              </span>
            ))}
